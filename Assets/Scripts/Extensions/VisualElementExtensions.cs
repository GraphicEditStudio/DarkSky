...
namespace Extensions
{
    public static class VisualElementExtensions
    {
        ...
        public static VisualElement AddChild(this VisualElement parent, params string[] classes)
        {
        ...
        public static T AddChild<T>(this VisualElement parent, params string[] classes) where T : VisualElement, new()
        {
            var child = new T();
            child.AddClass(classes);
            child.AddTo(parent);
